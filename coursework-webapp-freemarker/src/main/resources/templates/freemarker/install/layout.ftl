...
<head>
    ...
    <title><#if blockTitle??><@blockTitle/><#else>CourseWork安装程序</#if></title>
...
<div class="install-container">
    <div class="paper">
        <div class="paper-heading">
            <h1><span class="brand">CourseWork课程网</span> <span class="text-muted">安装向导 <small class="text-info">v${app_version!'5.3.2'}</small></span></h1>
        </div>
