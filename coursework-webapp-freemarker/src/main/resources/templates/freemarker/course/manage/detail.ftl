        ...
        <form id="course-base-form" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 controls">
                    <textarea name="about" rows="10" id="course-about-field" class="form-control" data-image-upload-url="${ctx}/editor_upload?token:upload_token=course" >{{ field_value(course, 'about') }}</textarea>
                </div>
            </div>
