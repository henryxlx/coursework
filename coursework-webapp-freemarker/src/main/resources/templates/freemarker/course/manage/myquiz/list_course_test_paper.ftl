...
<div class="panel panel-default panel-col">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs">
            <li class="<#if status?? && status == 'reviewing'>active</#if>"><a href="${ctx}/course/check/${course.id}/${'reviewing'}/list">未批阅</a></li>
            <li class="<#if status ?? && status == 'finished'>}active</#if>"><a href="${ctx}/course/check/${course.id}/${'finished'}/list>已批阅</a></li>
        </ul>
        <br>
