...
<#macro blockContent>
    ...
    <#if blockTimeoutDialog??><@blockTimeoutDialog/><#else>
    ...
    <#if blockTestpaperCheckedDialog??><@blockTestpaperCheckedDialog/><#else>
    ...
    <#if blockTestpaperFinishedDialog??><@blockTestpaperFinishedDialog/><#else>
                ...
                <div class="modal-dialog modal-dialog-small">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary" id="testpaper-finish-btn" data-saving-text="正在交卷, 请稍等...">
                                确认交卷
                            </button>
                        </div>
                    </div>
