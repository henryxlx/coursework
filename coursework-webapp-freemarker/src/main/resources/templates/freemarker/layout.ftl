...
<head>
    ...
    <title>
        <#assign blockTitleParent>${setting('site.name', 'CourseWork')}<#if setting('site.slogan')??> - ${setting('site.slogan')}</#if><#if setting('copyright.owned')??><#else> - Powered By CourseWork</#if></#assign>
        ...
        <div class="container">
            <div class="container-gap">
                <div class="navbar-header">
                    ...
                    <#else>
                        <a class="navbar-brand" href="${ctx}/index">${setting('site.name', 'CourseWork')}</a>
                    </#if>
                </div>
